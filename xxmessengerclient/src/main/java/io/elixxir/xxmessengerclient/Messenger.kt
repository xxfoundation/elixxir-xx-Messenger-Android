...
class Messenger(val env: MessengerEnvironment) {
    ...
    val registerForNotifications: MessengerRegisterForNotifications = MessengerRegisterForNotifications(env)
    val unregisterForNotifications: MessengerUnregisterForNotifications = MessengerUnregisterForNotifications(env)
    ...
    val registerBackupCallback: MessengerRegisterBackupCallback = MessengerRegisterBackupCallback(/* TODO */)
    val isBackupRunning: MessengerIsBackupRunning = MessengerIsBackupRunning(/* TODO */)
    val startBackup: MessengerStartBackup = MessengerStartBackup(/* TODO */)
    val resumeBackup: MessengerResumeBackup = MessengerResumeBackup(/* TODO */)
    val backupParams: MessengerBackupParams = MessengerBackupParams(/* TODO */)
    val stopBackup: MessengerStopBackup = MessengerStopBackup(/* TODO */)
}
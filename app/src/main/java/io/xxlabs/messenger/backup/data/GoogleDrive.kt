...
import io.xxlabs.messenger.backup.auth.GoogleAuthHandler
...
class GoogleDrive private constructor(
    ...
    private fun DriveFile.onSuccessfulUpload() {
        ...
        _lastBackup.postValue(driveBackupData)
    ...
    companion object {
        ...
        fun getInstance(backupService: BackupService, preferences: PreferencesRepository): GoogleDrive =
